...
export const metadata: Metadata = {
  title: "Brazilian Wax in Warner Robins, GA — Best Manicure & Pedicure Near You",
  description:
    "Find the best Brazilian Wax in Warner Robins, GA. Browse top-rated nail studios for brazilian wax, bikini wax, and full body waxing.",
  keywords: [
    "Brazilian Wax warner robins",
    "Brazilian Wax warner robins ga",
    ...
    <main className="min-h-screen bg-[#FDFAF7] text-[#2C1810]">
      ...
      <header className="sticky top-0 z-50 bg-[#FDFAF7]/95 backdrop-blur-sm border-b border-[#E8D5C4]">
        <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <nav className="hidden md:flex gap-6 text-sm text-[#6B4C3B]">
            ...
            <Link href="/brazilian-wax" className="text-[#C4856A] font-medium">Nails</Link>
      ...
      <section className="bg-[#2C1810] text-white py-16 px-6 relative overflow-hidden">
        ...
        <div className="relative max-w-6xl mx-auto">
          ...
          <h1 className="font-display text-4xl md:text-5xl font-bold mb-3">Brazilian Wax</h1>
          <p className="text-[#C4B89A] text-lg max-w-xl">
            Browse {businesses.length} top-rated Brazilian Wax in Warner Robins — brazilian wax, bikini wax, and full body waxing.
          </p>
        </div>
      </section>
...
<FeaturedListing />
      ...
      <div className="max-w-6xl mx-auto px-6 py-12">
        <div className="flex items-center justify-between mb-6">
          <h2 className="font-display text-2xl font-bold">All Brazilian Wax in Warner Robins</h2>
        ...
        <div className="mt-16 pt-8 border-t border-[#E8D5C4] text-[#6B4C3B]">
          <h2 className="font-display text-2xl font-bold text-[#2C1810] mb-3">Finding the Best Brazilian Wax in Warner Robins, GA</h2>
          <p className="mb-3">Warner Robins has a strong selection of Brazilian Wax offering everything from basic manicures and pedicures to elaborate nail art, gel extensions, and dip powder treatments. Whether you need a quick touch-up or a full nail makeover, the salons listed here are rated by real customers in the Warner Robins area.</p>
          <p>Popular services in Warner Robins Brazilian Wax include gel manicures, acrylic sets, SNS dip powder, and spa pedicures. Many salons also offer nail art and custom designs. Use this directory to compare ratings, read reviews, and find the Brazilian Wax nearest to you in Warner Robins, Centerville, Bonaire, or Kathleen, GA.</p>
        </div>
      </div>
      ...
      <footer className="border-t border-[#E8D5C4] bg-[#FDFAF7] py-10 px-6 mt-12">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-[#A0786A]">
          ...
          <nav className="flex gap-6">
            <Link href="/waxing" className="hover:text-[#C4856A] transition-colors">Waxing</Link>
            <Link href="/brazilian-wax" className="text-[#C4856A]">Nails</Link>
            <Link href="/hair-salons" className="hover:text-[#C4856A] transition-colors">Hair</Link>
            <Link href="/spas" className="hover:text-[#C4856A] transition-colors">Spas</Link>
          </nav>
