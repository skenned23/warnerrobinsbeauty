...
export const metadata: Metadata = {
  title: "Lash Extensions in Warner Robins, GA — Top Rated Lash Studios Near You",
  description: "Find the best lash extension studios in Warner Robins, GA. Browse top-rated lash artists for classic, hybrid, and volume lash extensions.",
  keywords: ["lash extensions warner robins", "eyelash extensions warner robins ga", "lash artist warner robins", "volume lashes warner robins"],
};
...
function getData(): Business[] {
  ...
  return JSON.parse(raw).categories["eyelash-extensions"] as Business[];
}
    ...
    <main className="min-h-screen bg-[#0A0A0A] text-white">
      ...
      <section className="relative py-16 px-6 overflow-hidden">
        ...
        <div className="relative max-w-6xl mx-auto">
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-3">Lash Extensions in Warner Robins</h1>
          <p className="text-white/40 text-lg max-w-xl">
            Browse {businesses.length} top-rated lash studios in Warner Robins — classic, hybrid, volume, and mega volume extensions.
          </p>
        </div>
      </section>
      ...
      <section className="border-b border-white/5 bg-white/[0.02]">
        <div className="max-w-6xl mx-auto px-6 py-4 flex flex-wrap gap-3">
          {["Classic Lashes", "Hybrid Lashes", "Volume Lashes", "Mega Volume", "Lash Lift", "Lash Tint", "Lash Fill", "Removal"].map((s) => (
      ...
      <div className="max-w-6xl mx-auto px-6 py-12">
        <div className="flex items-center justify-between mb-6">
          <h2 className="text-2xl font-bold">All Lash Studios in Warner Robins</h2>
        ...
        <div className="mt-16 pt-8 border-t border-white/5 text-white/40">
          <h2 className="text-2xl font-bold text-white mb-3">Finding the Best Lash Extensions in Warner Robins, GA</h2>
          <p className="mb-3">Warner Robins has a growing number of lash studios offering everything from classic single extensions to dramatic mega volume sets. Whether you want a natural everyday look or full glam lashes, the studios listed here are reviewed and rated by real customers in the Warner Robins area.</p>
          <p>Use this directory to compare ratings, read reviews, and find the best lash studio nearest to you in Warner Robins, Centerville, Bonaire, or Kathleen, GA.</p>
        </div>
      </div>

      <RelatedCategories current="lash-extensions" />
      ...
      <footer className="border-t border-white/5 py-10 px-6 mt-12">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-white/30">
          ...
          <nav className="flex gap-6 flex-wrap justify-center">
            ...
            <a href="/lash-extensions" className="text-[#D4A574]">Lash Extensions</a>
