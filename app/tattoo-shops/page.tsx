...
export const metadata: Metadata = {
  title: "Tattoo Shops in Warner Robins, GA — Top Rated Tattoo Artists Near You",
  description: "Find the best tattoo shops in Warner Robins, GA. Browse top-rated tattoo artists for custom tattoos, piercings, and permanent makeup.",
  keywords: ["tattoo shop warner robins", "tattoo artist warner robins ga", "piercing warner robins", "tattoo warner robins"],
};
...
function getData(): Business[] {
  ...
  return JSON.parse(raw).categories["tattoo-shops"] as Business[];
}
    ...
    <main className="min-h-screen bg-[#0A0A0A] text-white">
      ...
      <section className="relative py-16 px-6 overflow-hidden">
        ...
        <div className="relative max-w-6xl mx-auto">
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-3">Tattoo Shops in Warner Robins</h1>
          <p className="text-white/40 text-lg max-w-xl">
            Browse {businesses.length} top-rated tattoo shops in Warner Robins — custom tattoos, piercings, and permanent makeup.
          </p>
        </div>
      </section>
      ...
      <section className="border-b border-white/5 bg-white/[0.02]">
        <div className="max-w-6xl mx-auto px-6 py-4 flex flex-wrap gap-3">
          {["Custom Tattoos", "Cover Up", "Fine Line", "Traditional", "Realism", "Piercing", "Permanent Makeup", "Touch Up"].map((s) => (
      ...
      <div className="max-w-6xl mx-auto px-6 py-12">
        <div className="flex items-center justify-between mb-6">
          <h2 className="text-2xl font-bold">All Tattoo Shops in Warner Robins</h2>
        ...
        <div className="mt-16 pt-8 border-t border-white/5 text-white/40">
          <h2 className="text-2xl font-bold text-white mb-3">Finding the Best Tattoo Shop in Warner Robins, GA</h2>
          <p className="mb-3">Warner Robins has a strong selection of tattoo studios offering everything from custom designs and cover-ups to fine line work and realism. Whether you want your first tattoo or an addition to your collection, the artists listed here are reviewed and rated by real customers in the Warner Robins area.</p>
          <p>Use this directory to compare ratings, read reviews, and find the best tattoo shop nearest to you in Warner Robins, Centerville, Bonaire, or Kathleen, GA.</p>
        </div>
      </div>

      <RelatedCategories current="tattoo-shops" />
      ...
      <footer className="border-t border-white/5 py-10 px-6 mt-12">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-white/30">
          ...
          <nav className="flex gap-6 flex-wrap justify-center">
            ...
            <a href="/tattoo-shops" className="text-[#D4A574]">Tattoos</a>
